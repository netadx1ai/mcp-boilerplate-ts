...
export { BaseMcpServer, ServerBuilder, createServerBuilder, createBasicServer, 
// Convenience re-exports
BaseMcpServer as Server, ServerBuilder as Builder, } from './server.js';
 ...
 */
export async function createDevServer(name, tools = []) {
 ...
 */
export async function createProdServer(name, tools = []) {
    return createServerBuilder()
        .withConfig({
        name,
        version: '1.0.0',
 ...
 */
export async function createTestServer(name, tools = []) {
    return createServerBuilder()
        .withConfig({
        name,
        version: '1.0.0',
